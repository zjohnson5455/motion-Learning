...
var erase = false;
var c1 = 0;
var dataLog = {"mouse_x":[], "mouse_y":[],"time":[]};
...
var putPoint = function(e) {
  if (dragging && !erase) {
    ...
    (dataLog.mouse_x).push(e.clientX);
    (dataLog.mouse_y).push(e.clientY);
    (dataLog.time).push(getTime());
    console.log(dataLog);
    cString = c1.toString();
    c1 = c1 + 1;

    localStorage.setItem(cString, JSON.stringify(dataLog));
